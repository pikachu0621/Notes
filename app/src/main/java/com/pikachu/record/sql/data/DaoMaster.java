...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        AppOneDao.createTable(db, ifNotExists);
        DiaryDao.createTable(db, ifNotExists);
        MoodDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        AppOneDao.dropTable(db, ifExists);
        DiaryDao.dropTable(db, ifExists);
        MoodDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(AppOneDao.class);
